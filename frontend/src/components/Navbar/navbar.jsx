    ...
    <Menu as="div" className="relative">
      ...
      <AnimatePresence>
        <MenuItems 
          ...
          className="absolute right-0 mt-2 w-56 origin-top-right rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 shadow-lg ring-1 ring-white ring-opacity-5 focus:outline-none z-50 overflow-hidden"
        >
