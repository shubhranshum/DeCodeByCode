...
const ProfileHeader = ({ profile, onEditClick, theme, toggleTheme }) => {
  return (
        ...
        <div className="flex-1 w-full">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                <div className="flex items-start">
                  <svg className="w-5 h-5 text-slate-400 dark:text-gray-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                  <div>
                    <div className="text-xs text-slate-500 dark:text-gray-400">Age</div>
                    <div className="text-slate-700 dark:text-gray-200">{profile?.age || 'Not specified'}</div>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-slate-700 dark:text-gray-200">{profile?.email}</div>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-slate-700 dark:text-gray-200">{profile?.college || 'Not specified'}</div>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-slate-700 dark:text-gray-200">
                      {profile?.city ? `${profile.city}, ${profile.state}, ${profile.country}` : 'Not specified'}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-wrap gap-4 border-t border-slate-100 dark:border-gray-700 pt-4">
            <div className="flex items-center">
              ...
              <div>
                <div className="text-xs text-slate-500 dark:text-gray-400">Member since</div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <div className="text-xs text-slate-500 dark:text-gray-400">Last active</div>
                <div className="font-medium text-slate-800 dark:text-gray-200">
                  {profile && new Date(profile.lastSeenAt).toLocaleDateString('en-US', {
                    month: 'short',
                    day: 'numeric'
                  })}
                </div>
            ...
            {profile?.company && (
              <div className="flex items-center">
                ...
                <div>
                  <div className="text-xs text-slate-500 dark:text-gray-400">Company</div>
                  <div className="font-medium text-slate-800 dark:text-gray-200">
                    {profile?.company}
                  </div>
                </div>
